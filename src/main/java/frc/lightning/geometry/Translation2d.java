...
public class Translation2d implements ITranslation2d<Translation2d> {
    ...
    public boolean epsilonEquals(final Translation2d other, double epsilon) {
        return LightningMath.epsilonEqual(x(), other.x(), epsilon) &&
               LightningMath.epsilonEqual(y(), other.y(), epsilon);
    }
    ...
    public boolean equals(final Object other) {
        ...
        return distance((Translation2d) other) < LightningMath.kEpsilon;
    }
