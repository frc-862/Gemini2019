...
public class Elevator extends Subsystem {
  ...
  public void goToCollect() {
    motor1.set(ControlMode.MotionMagic, bottomOfTravel, gravityCompensation);
  }

  public void goToLow() {
    motor1.set(ControlMode.MotionMagic, lowDeployPosition, gravityCompensation);
  }

  public void goToMedium() {
    motor1.set(ControlMode.MotionMagic, mediumDeployPosition, gravityCompensation);
  }

  public void goToHigh() {
    motor1.set(ControlMode.MotionMagic, topOfTravel, gravityCompensation);
  }
}
