...
import frc.lightning.geometry.Pose2d;
import frc.lightning.geometry.Rotation2d;
import frc.lightning.geometry.Translation2d;
import frc.lightning.geometry.Twist2d;
import frc.lightning.util.InterpolatingDouble;
import frc.lightning.util.InterpolatingTreeMap;
import frc.lightning.util.Kinematics;
...
//            .kLidarYawAngleDegrees));
    ...
    public synchronized void reset(double start_time, Pose2d initial_field_to_vehicle) {
        ...
        Robot.core.setHeading(initial_field_to_vehicle.getRotation());
