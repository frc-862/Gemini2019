...
public class RobotMap {
    ...
    public static final int groundCollect = 26;
    ...
    public static final int hatchDetector = 11;
    //climber
    ...
    public static final int climbFwdChan = 2;//5;
    public static final int climbRevChan = 5;//2;
